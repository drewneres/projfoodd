...
<ul class="navbar navbar-dark bg-dark nav-pills nav-fill id='navmen' ">
            ...
            <li class="nav-item"><a class="nav-link text-white" href="?secao=manuterest">MANTER RESTAURANTE</a></li>
            <li class="nav-item"><a class="nav-link text-white" href="?secao=listarusuarios">LISTAR USUÁRIOS</a></li>
            <li class="nav-item"><a class="nav-link text-white" href="index.php">LOGOUT</a></li>
            <fo class="form-inline my-1 my-lg-0">
